        ...
        <tbody>
          <?php foreach ($projects as $project): ?>
              <tr>
                  ...
                  <td>
                      <a href="mobilisation_detail.php?project_id=<?= $project['id'] ?>" class="btn btn-sm btn-primary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem;">View</a>
                      <?php if (hasRole('admin') || hasRole('manager')): ?>
                          <a href="edit-project.php?id=<?= $project['id'] ?>" class="btn btn-sm" style="padding: 0.4rem 0.8rem; font-size: 0.85rem;">Edit</a>
                      <?php endif; ?>
                  </td>
              </tr>
          <?php endforeach; ?>
