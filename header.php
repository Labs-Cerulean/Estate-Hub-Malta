...
<body>
    ...
    <nav class="main-nav">
        <div style="max-width: 1440px; margin: 0 auto; display: flex; gap: 1rem; padding: 1rem 2rem;">
            ...
            <a href="clients.php" class="nav-link" <?php if (hasRole('viewer')) echo 'style="display:none;"'; ?>>Clients</a>
            <a href="create-project.php.php" class="nav-link" <?php if (hasRole('viewer')) echo 'style="display:none;"'; ?>>New Project</a>
