                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?edit=<?= $pro['id'] ?>" class="btn btn--sm btn--outline">Edit</a>
                                <form method="POST" style="display: inline;" onsubmit="return confirm('Delete this professional?')">
