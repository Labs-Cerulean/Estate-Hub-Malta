...
if ($action == 'finalize_and_invoice' && $canViewLedger) {
    ...
    // BULLETPROOF PAYLOAD: Perfectly matched to J2 Swagger Schema casing and typos
    $payload = [
        "Type" => "IN", 
        "PaymentType" => "", 
        ...
        "NominalAccount" => "", 
        "Transaction" => [ 
            "invioceHeader" => [  // Lowercase 'i', typo 'io'
                "THTranCode" => "IN", 
                "THDate" => date('Y-m-d'), 
                "THUserID" => "API", 
            ...
            "ledger" => "S",           // Lowercase 'l'
            "offlineDocRefs" => ""     // Lowercase 'o'
        ] 
    ];
