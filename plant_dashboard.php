...
$role = $_SESSION['role'] ?? '';
// Restrict to management and accounting
$hasDirectorAccess = in_array($role, ['admin', 'director', 'system_manager', 'accountant']);
if (!$hasDirectorAccess) {
    die("Unauthorized Access. This dashboard is restricted to Management and Accounting.");
}
...
<div id="jobModalOverlay">
    <div id="jobModal">
        ...
        <div style="margin-top: 25px; display: flex; justify-content: flex-end;">
            <button onclick="document.getElementById('jobModalOverlay').style.display='none'" style="padding: 10px 20px; background: #e
